...
<head>
    ...
    <meta name="keywords" content="HORIZON Hospitals">
        ...
        <div class="row">
            <div class="aa col-md-8">
                ...
                <form action="appointment 2.php" method="post">
                    ...
                    <p><input type="radio" name="disease" value="mild">Cardiology &nbsp;
                        <input type="radio" name="disease" value="serious">Deramtology and Cosmotology &nbsp; <br><br>
                        <input type="radio" name="disease" value="emergency">Emergency Care and CCU,ICU &nbsp;
                        <input type="radio" name="disease" value="emergency">General SUrgery &nbsp;
                        <br><br>
            ...
            <div class="col-md-4 div2">
                <div class="row">
                    <!--div class="col-md-6">
                        <span>
                            ...
                            $sql = "SELECT * FROM prescriptions WHERE name= '$username'";
                    ...
                    <div class="col-md-6">
                        ...
                        <?php
                            $username = $_SESSION["name"];
                            $date = date('Y-m-d');
                            $sql = "select * from appointments where username= '$username' and date >= '$date' ";
                            $result = $conn->query($sql);
                            if ($result->num_rows > 0) {
                                echo "<ul>";
                                while ($row = $result->fetch_assoc()) {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
$s = "SELECT * FROM prescriptions where name='$username'";
$res = $conn->query($s);
$r = $res->fetch_assoc();
?>
                        <a
                            href="prescription upload/<?php echo $r['filename'] ?>">
                    </div>
                </div>
            </div>
        </div>
