            ...
            <div class="col-md-8">
                <div class="main">
                    ...
                    <?php
                        ...
                        $today=date("Y-m-d");
                        $doctor=$_GET['rishi'];
                        $sql="select * from appointments where doctorname='$doctor' and date='$today' ";
                ...
                <div class="main">
                    ...
                    <?php
                       ...
                       $sql="select * from appointments where doctorname= '$doctor' and disease='mild' and date='$today' ";
                       $result=$conn->query($sql);
                       if ($result->num_rows>0) {
                           while ($row=$result->fetch_assoc()) {
                    ...
                    <?php
                        ...
                        $sql="select * from appointments where doctorname= '$doctor' and disease='serious' and date='$today' ";
                        $result=$conn->query($sql);
                        if ($result->num_rows>0) {
                            while ($row=$result->fetch_assoc()) {
                                echo"<h2>Name:".$row["username"];
                    ...
                    <?php
                        ...
                        $sql="select * from appointments where doctorname= '$doctor' and disease='emergency' and date='$today' ";
                        $result=$conn->query($sql);
                        if ($result->num_rows>0) {
                            while ($row=$result->fetch_assoc()) {
                                echo"<h2>Name:".$row["username"];
